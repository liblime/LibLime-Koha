...
function readCookie(name, wd) {
    ...
    if (wd) {
        ...
        // fixed - getting the part of the basket that is authority_list
...
function openBasket() {
    ...
    if ( strCookie ) {
        ...
        var loc = CGIBIN + "authorities/authority-basket.pl?" + strCookie;
...
function delSelRecords() {
    ...
    if (recordsSel) {
        ...
        document.location = CGIBIN + "authorities/authority-basket.pl?" + strCookie;
    }
    else {
...
function showMore() {
    ...
    var loc = CGIBIN + "authorities/authority-basket.pl?" + strCookie + "&verbose=1";
    document.location = loc;
}
...
function showLess() {
    ...
    var loc = CGIBIN + "authorities/authority-basket.pl?" + strCookie + "&verbose=0";
    document.location = loc;
}
