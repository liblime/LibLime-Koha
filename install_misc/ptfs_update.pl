...
print ".";
$dbh -> do("INSERT INTO systempreferences (variable,value,explanation,options,type) VALUES ('OwedNotificationValue',25.00,'Amount owed to receive a notification.  To work,EnableOwedNotification syspref will need to be turn ON.',NULL,'free');");
print ".";
...
print ".";
$dbh -> do("INSERT INTO systempreferences (variable,value,options,explanation,type) VALUES ('BatchMemberDeleteFineThreshhold','0.0','','Any borrower with an amount of fines greater than this value cannot be deleting via batch borrower deleting.','Float');");
print ".";
...
print ".";
$dbh -> do("INSERT INTO systempreferences (variable,value,options,explanation,type) VALUES ('DisableHoldsIssueOverrideUnlessAuthorised','1','','If this preference is enabled,it will block the staff.s ability to checkout items on hold,but includes a superlibrarian override.','YesNo');");
print ".";
...
print ".";
$dbh -> do("INSERT INTO systempreferences (variable,value,options,explanation,type) VALUES ('WarnOnlyOnMaxFine','0','','If UseGranularMaxFines and WarnOnlyOnMaxFine are both enabled,fine warnings will only occur when the fine for an item hit''s the max_fine attribute set in issuingrules.','YesNo');");
print ".";
...
print ".";
$dbh -> do("INSERT INTO systempreferences (variable,value,options,explanation,type) VALUES ('AllowMultipleHoldsPerBib','','','This allows multiple items per record to be placed on hold be a single patron. To enable,enter a list of space separated itemtype codes in the field (i.e. MAG JMAG YMAG). Useful for magazines,encyclopedias and other bibs where the attached items are not identical.','');");
print ".";
print "done!\n";
print "==========\n";
